...
export class FreezerChanged extends ethereum.Event {
  get params(): FreezerChanged__Params {
    return new FreezerChanged__Params(this);
  }
}

export class FreezerChanged__Params {
  _event: FreezerChanged;

  constructor(event: FreezerChanged) {
    this._event = event;
  }
...
export class SwapPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class SwapPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class SwapPair extends ethereum.SmartContract {
  static bind(address: Address): SwapPair {
    return new SwapPair("SwapPair", address);
  }
  ...
  burn(to: Address): SwapPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new SwapPair__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<SwapPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new SwapPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  freezer(): Address {
    let result = super.call("freezer", "freezer():(address)", []);

    return result[0].toAddress();
  }

  try_freezer(): ethereum.CallResult<Address> {
    let result = super.tryCall("freezer", "freezer():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getReserves(): SwapPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new SwapPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<SwapPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SwapPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
...
export class SetFreezerCall extends ethereum.Call {
  get inputs(): SetFreezerCall__Inputs {
    return new SetFreezerCall__Inputs(this);
  }

  get outputs(): SetFreezerCall__Outputs {
    return new SetFreezerCall__Outputs(this);
  }
}

export class SetFreezerCall__Inputs {
  _call: SetFreezerCall;

  constructor(call: SetFreezerCall) {
    this._call = call;
  }

  get _freezer(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetFreezerCall__Outputs {
  _call: SetFreezerCall;
